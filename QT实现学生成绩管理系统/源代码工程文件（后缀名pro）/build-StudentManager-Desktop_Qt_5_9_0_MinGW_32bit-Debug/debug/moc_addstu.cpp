...
QT_MOC_LITERAL(3, 25, 20), // "on_btncancel_clicked"
QT_MOC_LITERAL(4, 46, 15), // "on_stus_clicked"
QT_MOC_LITERAL(5, 62, 15), // "on_stum_clicked"
QT_MOC_LITERAL(6, 78, 15) // "on_stul_clicked"

    },
    "addstu\0on_btnok_clicked\0\0on_btncancel_clicked\0"
    "on_stus_clicked\0on_stum_clicked\0"
    "on_stul_clicked"
};
...
void *addstu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_addstu.stringdata0))
        return static_cast<void*>(const_cast< addstu*>(this));
